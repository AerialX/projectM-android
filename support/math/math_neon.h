...
#define ceil ceilf_neon
#define ceilf ceilf_neon
#define pow powf_neon
#define powf powf_neon
#define exp expf_neon
#define expf expf_neon
#define sin sinf_neon
#define sinf sinf_neon
#define cos cosf_neon
#define cosf cosf_neon
#define tan tanf_neon
#define tanf tanf_neon
#define asin asinf_neon
#define asinf asinf_neon
#define acos acosf_neon
#define acosf acosf_neon
#define atan atanf_neon
#define atanf atanf_neon
#define atan2 atan2f_neon
#define atan2f atan2f_neon
#define fabs fabsf_neon
#define fabsf fabsf_neon
#define log logf_neon
#define logf logf_neon
#define log10 log10f_neon
#define log10f log10f_neon
#define sqrt sqrtf_neon
#define sqrtf sqrtf_neon
#define invsqrt invsqrtf_neon
#define invsqrtf invsqrtf_neon
#define mod modf_neon
#define modf modf_neon

#define sincos sincosf_neon
#define sincosf sincosf_neon
#define sinh sinhf_neon
#define sinhf sinhf_neon
#define cosh coshf_neon
#define coshf coshf_neon
#define tanh tanhf_neon
#define tanhf tanhf_neon
#define ldexp ldexpf_neon
#define ldexpf ldexpf_neon
#define frexp frexpf_neon
#define frexpf frexpf_neon

#define hypot(x, y) sqrtf_neon(x*x+y*y)
